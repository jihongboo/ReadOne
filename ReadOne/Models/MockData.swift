...
enum MockData {
    ...
    static let feeds: [Feed] = {
        let feed1 = Feed(
            title: "少数派",
            url: URL(string: "https://sspai.com/feed")!,
            feedDescription: "高效工作，品质生活",
            imageURL: URL(string: "https://cdn.sspai.com/sspai/assets/img/favicon/icon.ico")
        )

        let feed2 = Feed(
            title: "Swift by Sundell",
            url: URL(string: "https://swiftbysundell.com/rss")!,
        ...
        let feed3 = Feed(
            ...
            url: URL(string: "https://hackingwithswift.com/feed")!,
        ...
        let articles1 = [
            Article(
                ...
                link: URL(string: "https://sspai.com/post/12345")!,
            ...
            Article(
                ...
                link: URL(string: "https://sspai.com/post/12346")!,
            ...
            Article(
                ...
                link: URL(string: "https://sspai.com/post/12347")!,
        ...
        let articles2 = [
            Article(
                ...
                link: URL(string: "https://swiftbysundell.com/articles/async-await")!,
                articleDescription:
                    "Swift's concurrency system, powered by async/await, provides a modern way to write asynchronous code that's both safe and easy to understand.",
            ...
            Article(
                ...
                link: URL(string: "https://swiftbysundell.com/articles/swiftui-views")!,
                articleDescription:
                    "Learn how to create reusable, composable UI components using SwiftUI's powerful view building system.",
        ...
        let articles3 = [
            Article(
                ...
                link: URL(string: "https://hackingwithswift.com/swift6")!,
                articleDescription:
                    "Swift 6.0 introduces complete concurrency checking, typed throws, and much more. Let's explore all the new features.",
    ...
    static var sampleStarredArticle: Article {
        let article = Article(
            ...
            imageURL: URL(string: "https://picsum.photos/400/300?random=5")
        )
